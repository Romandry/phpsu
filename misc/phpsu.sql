...
--
-- Host: localhost
-- Generation Time: Jul 01, 2015 at 04:42 AM
...
INSERT INTO `forum_subforums` (`id`, `sort`, `forum_id`, `topics_count`, `posts_count`, `last_post_id`, `title`, `description`) VALUES
(1, 1, 1, 2, 9, 33, 'Экономика', 'Обсуждение экономических событий'),
(2, 2, 1, 1, 2, 5, 'Политика', 'Обсуждение политических событий'),
(3, 3, 1, 4, 9, 23, 'Корпоративные вопросы', 'Внутренняя кухня компании '),
(4, 1, 2, 0, 0, 0, 'Маркетинг', 'Реклама и прочее '),
(5, 2, 2, 0, 0, 0, 'Продажа', 'Предложения '),
(6, 3, 2, 2, 3, 34, 'Покупка', 'Спрос '),
(7, 4, 1, 4, 15, 40, 'Прочее', 'Обсуждение остальных вопросов'),
(8, 5, 1, 1, 2, 31, 'Новости и события', 'Последние сводки и их обсуждение');
...
INSERT INTO `forum_topics` (`id`, `subforum_id`, `authored_by`, `title`, `description`, `creation_date`, `last_modified`, `posts_count`, `views_count`, `locked`) VALUES
(1, 1, 14, 'Тестовая тема', 'Это описание', '2014-12-05 13:29:40', '2014-12-05 13:34:52', 2, 51, 0),
(2, 2, 16, 'Всё плохо', 'танунах', '2014-12-05 13:36:20', '2014-12-05 13:38:21', 2, 48, 0),
(3, 6, 16, 'Куплю Фаллоимитатор бу', '', '2014-12-05 13:37:31', '2014-12-05 13:42:18', 2, 84, 0),
(4, 1, 9, 'Орма и теребонькаенье', '', '2014-12-05 13:39:55', '2014-12-05 14:17:10', 7, 1191, 0),
(5, 8, 11, 'Орма снова оттеребонькал', '', '2014-12-05 13:43:05', '2014-12-05 14:05:30', 2, 72, 0),
(6, 7, 11, 'Вы все сосцы', '', '2014-12-05 13:43:32', '2014-12-05 14:01:48', 5, 358, 0),
(7, 7, 14, 'К пользователю test9', 'Личный публичный вопрос', '2014-12-05 13:45:53', '2014-12-05 13:47:49', 2, 51, 0),
(8, 3, 11, 'Счетчик в топе', '', '2014-12-05 13:49:12', '2014-12-05 13:51:24', 2, 56, 0),
(9, 3, 11, 'Добавить ответ по контрол+ентер', '', '2014-12-05 13:52:00', '2014-12-05 13:54:27', 2, 308, 0),
(10, 3, 14, 'Счетчик в попе', '', '2014-12-05 13:55:20', '2014-12-05 13:56:04', 2, 53, 0),
(11, 3, 11, 'Сообщение не добавляется как новое', '', '2014-12-05 13:57:33', '2014-12-05 14:07:16', 3, 57, 0),
(12, 7, 14, 'Можт сюда нагнать весь пхпсу?', '', '2014-12-05 14:03:22', '2014-12-05 14:03:54', 2, 65, 0),
(13, 6, 17, 'UPS DC 24V', '', '2014-12-06 14:36:53', '2014-12-06 14:36:53', 1, 53, 0),
(14, 7, 17, 'bug check', '', '2014-12-06 14:39:33', '2014-12-06 18:38:05', 6, 117, 0);
...
('u638o4ukl4535htqqavfd7fgi0', 0x696461376e38563946356953514e69744a46416c7a5a3442704933635f6f4f3378535169536f6547684b6f436e50307778576c6b6e4d48626f62635f5a36546373764443443554423961355048464447796a2d7651672e2e, '2015-07-01 04:41:57'),
